...
test.gt.dir <- c(length(test.gt.dir), test.gt.dir)
write.table(test.set.dir, "data_base_10.dir", quote=F, col.names=F, row.names=F)
write.table(test.gt.dir, "data_gt_10.dir", quote=F, col.names=F, row.names=F)
...
write.table(test.gt.dir, "data_gt_20.dir", quote=F, col.names=F, row.names=F)
...
write.table(test.gt.dir, "data_gt_40.dir", quote=F, col.names=F, row.names=F)
...
write.table(test.gt.dir, "data_gt_60.dir", quote=F, col.names=F, row.names=F)
